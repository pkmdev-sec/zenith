---
name: contributing
description: Contribute changes to the Zenith repository itself. Use when the task is to add features, fix bugs, update prompts or skills, change install or release behavior, improve docs, or prepare a focused PR against this repo.
---
...
Use this skill when working on Zenith itself, especially for:

- CLI or runtime changes in `src/`
- prompt changes in `prompts/`
- bundled skill changes in `skills/`
- subagent behavior changes in `.zenith/agents/`
