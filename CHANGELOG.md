...
- **Two research tiers** — broad (100–200 agents, default) and expensive (300–500 agents via `/deepresearch`)
...
Seven slash commands: `/deepresearch`, `/swarm`, `/export`, `/eli5`, `/session-search`, `/session-log`, `/preview`
