...
export type ZenithStatusSnapshot = {
	model?: string;
	modelValid: boolean;
...
export function collectStatusSnapshot(options: DoctorOptions): ZenithStatusSnapshot {
...
export function runDoctor(options: DoctorOptions): void {
	...
	console.log("setup hint: zenith setup");
}
