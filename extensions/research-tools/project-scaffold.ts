export function buildProjectAgentsTemplate(): string {
	return `# Zenith Project Guide

This file is read automatically at startup. It is the durable project memory for Zenith.
...
Use \`/log\` to write one durable note per meaningful Zenith session.
