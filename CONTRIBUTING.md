...
Zenith is a research-first CLI built on Pi and alphaXiv. This guide is for humans and agents contributing code, prompts, skills, docs, installers, or workflow behavior to the repository.
...
If you need to change how bundled subagents behave, edit `.zenith/agents/*.md`. Do not duplicate that behavior in `AGENTS.md`.
